    ...
    return (
        <div>
            ...
            <div>
                ...
                <button><Link to="/jobs">View more jobs</Link></button> 
            </div>
            <div>
                ...
                <button><Link to="/skills">View more skills</Link></button>
            </div>
            <div>
                ...
                <button><Link to="/contacts">View more contacts</Link></button>
            </div>
            <Footer />
        </div>
    );
